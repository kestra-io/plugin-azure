...
- This plugin integrates Kestra with ADLS.
- It provides tasks that work with Azure Data Lake Storage for large-scale file operations and analytics workloads.
